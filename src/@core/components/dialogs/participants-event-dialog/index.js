...
import { Button, DialogActions, DialogContent, DialogContentText, DialogTitle, Chip } from '@mui/material'
              ...
              {users.map((row) => (
                ...
                >
                  ...
                  <TableCell align="center">
                    {renderChipStatus(row.status)}
                  </TableCell>
                  <TableCell align="center">
                    {renderButtonStatus(row.status, row.id)}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
